...
public class Grades {
	...
	public void calculateTotalGrade(double lab1Weight, double lab2Weight,
		...
		midtermflag = false;
		finalflag = false;
		if(lab1Weight<0||lab1Weight>0.3){
			lab1flag = true;
			System.out.println("lab1Weight is out of range");
		}
		if(lab2Weight<0||lab2Weight>0.3){
			lab2flag = true;
			System.out.println("lab2Weight is out of range");
		}
		if(lab3Weight<0||lab3Weight>0.3){
			lab3flag = true;
			System.out.println("lab3Weight is out of range");
		}
		if(midTermWeight<0||midTermWeight>0.3){
			midtermflag = true;
			System.out.println("midTermWeight is out of range");
		}
		if(finalExamWeight<0||finalExamWeight>0.3){
			finalflag = true;
			System.out.println("finalExamWeight is out of range");
		}
		if(!lab1flag&&!lab2flag&&!lab3flag&&!midtermflag&&!finalflag){
